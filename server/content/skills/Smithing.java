...
public class Smithing extends SmithingData {
	...
	public static void Smithbar(final Client c, final int itemId,
		...
		CycleEventHandler.getSingleton().addEvent(eventId, c, new CycleEvent() {
			...
			public void execute(CycleEventContainer container) {
				...
				c.getPA()
						.addSkillXP(XP * 5, c.playerSmithing);
	...
	public static int[][] data1 = {
			...
			// Final item(BAR)
			{ 1, 1, 30, COPPER, TIN, -1, 2349 }, // Bronze
			{ 2, 15, 60, IRON, -1, -1, 2351 }, // iron
			{ 3, 20, 85, IRON, COAL, 2, 2353 }, // Steel
			{ 4, 50, 150, MITH, COAL, 4, 2359 }, // Mith
			{ 5, 70, 185, ADDY, COAL, 6, 2361 }, // Addy
			{ 6, 85, 250, RUNE, COAL, 8, 2363 }, // Rune
			/** ---------------OTHERS------------/ */
			{ 7, 20, 65, SILVER, -1, -1, 2355 }, // Silver
			{ 8, 40, 110, GOLD, -1, -1, 2357 } // GOLD
	};
