...
public class Fishing extends SkillHandler {
	...
	public static int[][] data = {
		{1, 1, 303, -1, 317, 50, 621, 321, 15, 150},		//SHRIMP + ANCHOVIES
		{2, 5, 307, 313, 327, 100, 622, 345, 10, 150},		//SARDINE + HERRING
		{3, 16, 305, -1, 353, 100, 620, -1, -1, -1},		//MACKEREL
		{4, 20, 309, 314, 335, 250, 622, 331, 30, 350},		//TROUT
		{5, 23, 305, -1, 341, 225, 619, 363, 46, 500},		//BASS + COD
		{6, 25, 309, 313, 349, 300, 622, -1, -1, -1},		//PIKE
		{7, 35, 311, -1, 359, 400, 618, 371, 50, 500},		//TUNA + SWORDIE
		{8, 40, 301, -1, 377, 450, 619, -1, -1, -1},		//LOBSTER
		{9, 76, 311, -1, 383, 550, 618, -1, -1, -1},		//SHARK
	};
	private static String[][] messages = {
		{"You cast out your net."},		//SHRIMP + ANCHOVIES
		{"You cast out your line." },		//SARDINE + HERRING
		{"You start harpooning fish."},		//TUNA + SWORDIE + SHARK
	...
	public static String messages(Client c) {
		...
		if(c.playerSkillProp[10][10] == 9) //shark
			return messages[2][0];
