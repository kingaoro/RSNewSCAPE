...
public class Config {
	...
	public static final String SERVER_NAME = "NewScape 2006";
	public static final String WEBSITE_URL = "www.newscape-2006.com";
	...
	public static final int MELEE_EXP_RATE = 20; //xp rate is 5x normal xp
