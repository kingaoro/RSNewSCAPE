...
public class UseItem {
	...
	public static void ItemonItem(Client c, int itemUsed, int useWith) {
		...
		if (itemUsed == 237 || itemUsed == 1973 || itemUsed == 243 || useWith == 237 || useWith == 1973 || useWith == 243){
			if(Herblore.Grind.forId(itemUsed) != null)
				Herblore.grindIngredient(c, itemUsed);
			else if (Herblore.Grind.forId(useWith) != null)
				Herblore.grindIngredient(c, useWith);
		}
		if (itemUsed == Herblore.vial || useWith == Herblore.vial){
                        if(Herblore.UPotions.forId(itemUsed) != null)
                                Herblore.makeUnfPotion(c, itemUsed);
                        else if (Herblore.UPotions.forId(useWith) != null)
                                Herblore.makeUnfPotion(c, useWith);
                }
                if (itemUsed == 91 || itemUsed == 93 || itemUsed == 95 || itemUsed == 97 || itemUsed == 99
                	 || itemUsed == 3002 || itemUsed == 101 || itemUsed == 103 || itemUsed == 105 || itemUsed == 3004
                  || itemUsed == 107 || itemUsed == 109 || itemUsed == 111 || useWith == 91 || useWith == 93
                   || useWith == 95 || useWith == 97 || useWith == 99 || useWith == 3002 || useWith == 101
                    || useWith == 103 || useWith == 105 || useWith == 3004 || useWith == 107 || useWith == 109
                     || useWith == 111){
