...
public class Client extends Player {
	...
	public void initialize() {
		...
		if (tutorialprog == 0) {
			Tutorialisland.sendDialogue(this, 3115, 0);
			tutorialprog = 36;
		}
		if(isRunning2) {
		...
		sendMessage("Please register on the forums " + Config.WEBSITE_URL +" to gain access to the");
		sendMessage("full experience, and highscores!");
		if(playerDonor >= 1){
			sendMessage("You are currently a @gre@Donator@blk@");
		}
	...
	public void handleWelcomeScreen() {
	   getPA().sendFrame126("Welcome to Newscape!", 15259); 
	...
	public void logout() {
		if (playerRights != 2 && playerRights != 3 && !playerName.equalsIgnoreCase("Vid Account")){
