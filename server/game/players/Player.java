...
public abstract class Player extends Mobile {
	...
	if ((absX >= 3136 && absX <= 3327 && absY >= 3519 && absY <= 3607)
		...
		|| (absX >= 2653 && absX <= 2729 && absY >= 3714 && absY <= 3738)
		|| (absX >= 2660 && absX <= 2729 && absY >= 3713 && absY <= 3738)
		|| (absX >= 2662 && absX <= 2729 && absY >= 3712 && absY <= 3738)
		|| (absX >= 2702 && absX <= 2729 && absY >= 3711 && absY <= 3738)
		|| (absX >= 2703 && absX <= 2729 && absY >= 3710 && absY <= 3738)) {
	    return true;
	}
	return false;
    }
