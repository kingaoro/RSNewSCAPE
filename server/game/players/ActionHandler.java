...
public class ActionHandler {
	 ...
	 * Banana
	 */
 case 11727://FALADORladders
 	 if (c.objectX == 2994 && c.objectY == 3341)
 	 	 c.startAnimation(828);
 	 	 c.getPA().movePlayer(2995, 3341, 1);
 	 if (c.objectX == 2996 && c.objectY == 3341)
 	 	 c.startAnimation(828);
 	 	 c.getPA().movePlayer(2995, 3341, 2);
 	 break;
 case 11728:
 	 if (c.objectX == 2994 && c.objectY == 3341)
 	 	 c.startAnimation(828);
 	 	 c.getPA().movePlayer(2995, 3341, 0);
 	 if (c.objectX == 2996 && c.objectY == 3341)
 	 	 c.startAnimation(828);
 	 	 c.getPA().movePlayer(2995, 3341, 1);
 	 	 break;
 	 //white knight castle stairs to cupboard	 
 	 case 11734:
 	 	 if (c.objectX == 2984 && c.objectY == 3337)
 	 	 	 c.getPA().movePlayer(2985, 3340, 2);
 	 	 break;
 	case 11735:
 		if (c.objectX == 2984 && c.objectY == 3338)
 		c.getPA().movePlayer(2984, 3336, 1);
 		break;
	...
	case 2073:
	    ...
	    break;
	// /BANANNA END////
	//RUNECRAFTING ENTERING ALTAR TEMP METHOD//
case 2471:
	if (c.objectX == 2986 && c.objectY == 3294){
		if(c.getItems().playerHasItem(1439, 1) && c.runeM == 7){
	...
	case 4031:
	case 1596:
		if (c.absX == 2935 && c.absY == 3451);
		c.getPA().movePlayer(2936, 3451, 0);
		if (c.absX == 2936 && c.absY == 3451)
		c.getPA().movePlayer(2935, 3451, 0);
		break;
	case 1597:
		if (c.absX == 2936 && c.absY == 3450)
		c.getPA().movePlayer(2935, 3450, 0);
		else if (c.absX == 2935 && c.absY == 3450)
		c.getPA().movePlayer(2936, 3450, 0);
		break;
	case 3198:
	case 3197:
	case 9295:
	...
	default:
	    ...
	    if(name.contains("Deposit Box")){
			c.getPA().sendFrame126("The Bank of NewScape - Deposit Box", 7421);
	...
	case 604:
	    ...
	    if (c.knightS == 8){
	    	KnightSwordD.dialogue(c, 673, 604);
	    }
	    break;
	case 553:
	    if (c.runeM == 3) {
